  ...
  return (
    <>
      <div className="bg-gray-200 h-full w-full">
        {/* Code block starts */}
        <nav className="w-full bg-gray-800 hidden xl:block shadow" id="navbar">
          <div className="container px-6 h-16 flex justify-between items-center lg:items-stretch mx-auto">
            ...
            <div className="flex items-center xl:hidden">
              <ul className="p-2 border-r bg-white absolute rounded top-0 left-0 right-0 shadow mt-16 md:mt-16 hidden">
                ...
                <li
                  className="flex md:hidden flex-col cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none justify-center"
                ...
                >
                  <div className="flex items-center">
                    ...
                    <span className="ml-2 font-bold">Directory</span>
                  </div>
                </li>
                ...
                <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none"></li>
              </ul>
            </div>
          </div>
        </nav>
                    ...
                    <div className="mt-6 flex w-full items-center justify-between">
                      <div className="flex items-center justify-between w-full">
                        <div className="flex items-center">
                          ...
                          <p className="text-base  text-white ml-3">BotDock</p>
                        </div>
                        <div
                          id="cross"
                          className="text-white"
...
// const navigation = [
//   { name: 'BotDock', href: 'Home', current: true },
