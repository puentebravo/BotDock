          ...
          <div className="relative z-10 w-full">
            <div className="w-full -mt-8 h-auto">
              <div className="w-full h-auto lg:h-20 mb-6 rounded shadow bg-white">
                ...
                <ul
                  className="hidden lg:flex flex-row items-center h-full"
                  style={{ marginTop: "2.6%" }}
                >
                  <li
                    className="pl-10 my-0 text-base text-gray-600"
                    onClick={() => setSelectedBot(0)}
                  >
                ...
                <div className="bg-white w-full h-full rounded shadow">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    >
                      ...
                      <img
                        src="https://webstockreview.net/images/clipart-monkey-gif-animation-12.gif"
                        style={{
                          height: "20%",
                          width: "20%",
                          marginLeft: "auto",
