        ...
        <div style={{minHeight: "100%"}}>
            ...
            <div className="relative z-10 bg-gray-800 pt-8 pb-16">
                <div className="container px-6 mx-auto flex flex-col lg:flex-row items-start lg:items-center justify-between">
                    <div>
                        <h4 className="text-2xl font-bold leading-tight text-white" style={{marginBottom:"-5%"}}>Directory</h4>
                    </div>
                </div>
            </div>                          
            {/* Page title ends */}
                                ...
                                <div className="bg-white w-full h-full rounded shadow">
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="border-solid border-4 h-48 overflow-scroll" style={{height: "100%"}}>
                                            ...
                                            <img src="https://media0.giphy.com/media/3og0IUzdgwVczU67eg/giphy.gif" style={{height: "20%", width: "30%", marginLeft:"auto", marginRight:"auto"}} />
                                            ...
                                            <div>
                                                <div className="p-8 border-solid border-4" >
                                                    ...
                                                    <div className="text-center">
                                                        ...
                                                        <br></br><br></br>
                                                        <img src="https://lh3.googleusercontent.com/proxy/iFXH4nqQN9XWJpVcz2FbXfvaFhbMbN4GjQZGq8kjOXNARGr51oWarMwR9I3LilrYzHRFzNGs1PGBWxVRF19QU3cetrHteBM30qqGz0B8sCm_MaEHed8Q-wkzeEX4vVvSJlPON2_jY1dyvqFSXx8WBMG_s9GsMVwQJ-2EaFnzdRwJajSBY5Te8RcHhiIPcq8" style={{height: "20%", width: "20%", marginLeft:"auto", marginRight:"auto"}}/>
                                                    </div>
